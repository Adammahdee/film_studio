<?php
// This file is included by public/index.php, so ROOT_PATH, url(), and session are available.
...
<nav class="navbar navbar-expand-lg bg-white shadow-sm">
    <div class="container">
        <a class="navbar-brand fw-semibold" href="<?= url('landing') ?>"><?= htmlspecialchars($site_name) ?></a>
        <div class="d-flex gap-2">
            <?php if ($isLoggedIn): ?>
                <a href="<?= url('dashboard') ?>" class="btn btn-primary">Dashboard</a>
            <?php else: ?>
                <a href="<?= url('auth') ?>" class="btn btn-outline-primary">Login</a>
            <?php endif; ?>
        </div>
    </div>
</nav>
            ...
            <div class="row align-items-center g-5">
                <div class="col-lg-7">
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        <?php if ($isLoggedIn): ?>
                            <a href="<?= url('dashboard') ?>" class="btn btn-light btn-lg">Open Dashboard</a>
                        <?php else: ?>
                            <a href="<?= url('auth') ?>" class="btn btn-light btn-lg">Login</a>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="col-lg-5">
